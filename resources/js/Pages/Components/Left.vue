    ...
    <div>
        ...
        <div class="w-68 xs:w-88 xl:w-275 h-screen">
            <div class="flex flex-col h-screen xl:pr-3 fixed overflow-y-auto w-68 xs:w-88 xl:w-275">
                <!-- Logo -->
                <InertiaLink href="/" class="flex my-2 justify-center xl:justify-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"
                        stroke="#e77975" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Popover v-if="$page.props.user !== null" v-slot="{ open }" class="relative">
                    <PopoverButton :class="open ? '' : 'text-gray-600 dark:text-gray-300'"
                        class="w-14 xl:w-full mx-auto mt-auto flex flex-row justify-between rounded-full hover:bg-red-50 dark:hover:bg-dim-800 p-2 cursor-pointer transition duration-350 ease-in-out">
